...
function NetflixClone() {
  ...
  <header className="showcase">
    <div className="showcase-top">
      ...
      <a href="#" className="btn btn-rounded btn-danger">
        Sign In
      </a>
    </div>
    <div className="showcase-content">
      <h1 className='text-light'>See what's next</h1>
      <p>Watch anywhere. Cancel Anytime</p>
      <a href="#" className="btn btn-xl btn-secondary">
        Watch Free For 30 Days <i className="fas fa-chevron-right btn-icon" />
      </a>
    </div>
  </header>
  <section className="tabs">
    <div className="container">
      <div id="tab-1" className="tab-item tab-border">
        ...
        <p className="hide-sm text-secondary">Cancel at any time</p>
      </div>
      <div id="tab-2" className="tab-item">
        <i className="fas fa-tablet-alt fa-3x" />
        <p className="hide-sm text-secondary">Watch anywhere</p>
      </div>
      <div id="tab-3" className="tab-item">
        <i className="fas fa-tags fa-3x" />
        <p className="hide-sm text-secondary">Pick your price</p>
      </div>
    </div>
  </section>
